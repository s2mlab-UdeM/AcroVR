...
namespace Crosstales.FB.Wrapper
{
    ...
    public abstract class FileBrowserBase : IFileBrowser
    {
        ...
        /// <summary>
        /// Default constructor for a wrapper.
        /// </summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of the FileBrowser</param>
        public FileBrowserBase(MonoBehaviour obj)
        {
            fbObj = obj;
        }
...
*/
        ...
        protected static void onSingleFileSelected(string file)
        {
