namespace Crosstales.FB.Util
{
    ...
    public abstract class Constants : Common.Util.BaseConstants
    {
        ...
        public const string ASSET_VERSION = "2019.1.2";

        /// <summary>Build number of the asset.</summary>
        public const int ASSET_BUILD = 20190128;
        ...
        public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2019, 1, 28);
        ...
        /// <summary>FileBrowser prefab scene name.</summary>
